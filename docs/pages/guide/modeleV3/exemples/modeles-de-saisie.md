...
[paragraphe dédié]({{ '/pages/guide/modeleV3/resources/questionnaire.html#parametres-recherche' | relative_url }}).
...
* utiliser les critères de recherche défini au [paragraphe dédié]({{ '/pages/guide/modeleV3/resources/questionnaire.html#parametres-recherche' | relative_url }})
