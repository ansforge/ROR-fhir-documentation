...
-    [StructureDefinition-ror-location]({{ '/pages/guide/modeleV3/resources/search-params/location.html' | relative_url }})
-    [StructureDefinition-ror-healthcareservice]({{ '/pages/guide/modeleV3/resources/search-params/healthcareservice.html' | relative_url }}) (critères de recherche applicables à la ressource Location, grâce au [chainage inversé](https://www.hl7.org/fhir/R4/search.html#has). Pour cela utiliser la syntaxe suivante :`_has:HealthcareService:location:[NOM CRITERE]`)
