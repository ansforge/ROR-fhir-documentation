...
-    [StructureDefinition-ror-location]({{ '/pages/guide/modeleV3/resources/location.html#parametres-recherche' | relative_url }})
-    [StructureDefinition-ror-healthcareservice]({{ '/pages/guide/modeleV3/resources/healthcare-service.html#parametres-recherche' | relative_url }}) (critères de recherche applicables à la ressource Location, grâce au [chainage inversé](https://www.hl7.org/fhir/R4/search.html#has). Pour cela utiliser la syntaxe suivante :`_has:HealthcareService:location:[NOM CRITERE]`)
-    [StructureDefinition-ror-task]({{ '/pages/guide/modeleV3/resources/search-params/task.html' | relative_url }}) (critères de recherche applicables à la ressource Location, grâce au [chainage inversé](https://www.hl7.org/fhir/R4/search.html#has). Pour cela utiliser la syntaxe suivante :`_has:HealthcareService:location:[NOM CRITERE]`)
