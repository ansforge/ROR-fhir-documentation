...
**Requête :** Voir [scénario 1 du cas d'usage création et mise à jour du lieu de réalisation de l'offre]({{ '/pages/guide/modeleV3/exemples/creation-maj-lieu-offre.html' | relative_url }}#scénario-1-ajout-dun-lieu-de-réalisation-de-loffre-draft) (Ajout d’un lieu de réalisation de l’offre)
