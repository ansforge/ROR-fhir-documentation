...
<table align="center">
    <tr>
        ...
        <td align ="center">
            <div class="figure">
				<img src="{{ '/assets/img/pagecontent/creation-maj-offre_scenario9_avant.png' | relative_url }}" title="Avant" width="1000">
            </div>
        </td>   
    </tr>
	    <tr>
        ...
        <td align ="center">
            <div class="figure">
				<img src="{{ '/assets/img/pagecontent/creation-maj-offre_scenario9_apres.png' | relative_url }}" title="Après" width="1000">
            </div>
        </td>    
    </tr>
</table>
