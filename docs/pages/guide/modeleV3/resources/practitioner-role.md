...
Des exemples de requêtes `GET` sur cette ressource sont disponibles sur la page [GET &gt; RORPractitionerRole]({{ '/pages/guide/modeleV3/get/practitioner-role.html' | relative_url }}).
