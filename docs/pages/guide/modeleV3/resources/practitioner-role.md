...
L'ensemble des paramètres de recherche applicables à cette ressource est détaillé sur la page [Paramètres de recherche — RORPractitionerRole]({{ '/pages/guide/modeleV3/resources/search-params/practitionerrole.html' | relative_url }}).
