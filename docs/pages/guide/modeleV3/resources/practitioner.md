...
Des exemples de requêtes `GET` sur cette ressource sont disponibles sur la page [GET &gt; RORPractitioner]({{ '/pages/guide/modeleV3/get/practitioner.html' | relative_url }}).
