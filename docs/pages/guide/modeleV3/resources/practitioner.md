...
L'ensemble des paramètres de recherche applicables à cette ressource est détaillé sur la page [Paramètres de recherche — RORPractitioner]({{ '/pages/guide/modeleV3/resources/search-params/practitioner.html' | relative_url }}).
