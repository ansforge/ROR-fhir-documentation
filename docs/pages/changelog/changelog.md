...
* [narratif] Modification du tableau référençant les [Search Params pour ROROrganization]({{ site.ror.ig_url }}/search_param.html#structuredefinition-ror-organization) [374](https://github.com/ansforge/IG-fhir-repertoire-offre-ressources-sante/issues/374)
* [narratif] Correction de l'exemple de requête (code inactivation) dans le [scénario 2 : Inactivation d'une anomalie]({{ site.ror.ig_url }}/specifications_techniques_6.html#scénario-2-inactivation-dune-anomalie) [360](https://github.com/ansforge/IG-fhir-repertoire-offre-ressources-sante/issues/360), [361](https://github.com/ansforge/IG-fhir-repertoire-offre-ressources-sante/issues/361)
* [narratif] Ajout de la description du cas d'usage "Consignes  fiche de saisie de l'offre" dans la page [Spécifications fonctionnelles]({{ site.ror.ig_url }}/specifications_fonctionnelles.html#consignes-fiche-de-saisie-de-loffre) [365](https://github.com/ansforge/IG-fhir-repertoire-offre-ressources-sante/issues/365)
* correction de l'exemple de ressouce dans le [scénario 1 "Création du nouveau lieu de réalisation de l'offre"]({{ site.ror.ig_url }}/specifications_techniques_10.html#spécifique-serveur-scénario-1-ajout-dun-lieu-de-réalisation-de-loffre-draft) [384](https://github.com/ansforge/IG-fhir-repertoire-offre-ressources-sante/issues/384)
...
Version qui inclut également les modifications réalisées pour la [version 0.4.0 snapshot-1](#version-040-snapshot-1).
